...
No fiduciary, agency, partnership, joint venture, employer-employee, or franchiser-franchisee relationship is created between us and any user of the Platform.
...
### 4.1 No Liability for Transactions

**TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, WE SHALL NOT BE LIABLE FOR ANY LOSS, DAMAGE, INJURY, CLAIM, OR LIABILITY ARISING FROM OR RELATED TO ANY TRANSACTION, INTERACTION, COMMUNICATION, MEETING, OFFER, APPRAISAL, PURCHASE, SALE, TRADE, EXCHANGE, OR DISPUTE BETWEEN ANY USERS OF THE PLATFORM.**

This includes, without limitation:
- Financial losses from sales at prices below market value
- Losses from fraud, misrepresentation, or theft by any user
- Damage to or loss of Items before, during, or after any transaction
- Personal injury occurring at any coin show or during any meeting
- Disputes over grading, authenticity, or condition of Items
- Failure of any party to honor commitments made through the Platform
- Errors in Item descriptions, photographs, or valuations submitted by users

### 4.2 General Limitation

TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL WE, OUR OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, OR AFFILIATES BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, REVENUE, DATA, OR USE, ARISING OUT OF OR RELATED TO YOUR USE OF THE PLATFORM, REGARDLESS OF THE THEORY OF LIABILITY (CONTRACT, TORT, STRICT LIABILITY, OR OTHERWISE), EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.

### 4.3 Aggregate Cap

OUR TOTAL AGGREGATE LIABILITY FOR ALL CLAIMS ARISING FROM OR RELATED TO THE PLATFORM SHALL NOT EXCEED THE GREATER OF (A) THE AMOUNT YOU PAID TO US, IF ANY, IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM, OR (B) ONE HUNDRED DOLLARS ($100.00 USD).

---

## 5. Indemnification

You agree to indemnify, defend, and hold harmless Coin Show Near Me, its officers, directors, employees, agents, and affiliates from and against any and all claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys' fees) arising from or related to:
...
- Any claim that your use of the Platform infringed or violated the rights of a third party
...
THE PLATFORM IS PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS, WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED. WE EXPRESSLY DISCLAIM ALL WARRANTIES, INCLUDING BUT NOT LIMITED TO:

- IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT
- WARRANTIES RELATING TO THE ACCURACY, RELIABILITY, OR COMPLETENESS OF ANY CONTENT ON THE PLATFORM
- WARRANTIES THAT THE PLATFORM WILL BE UNINTERRUPTED, ERROR-FREE, OR SECURE
- WARRANTIES RELATING TO THE QUALITY, LEGALITY, OR SAFETY OF ANY ITEMS LISTED OR DESCRIBED ON THE PLATFORM
- WARRANTIES RELATING TO THE QUALIFICATIONS, IDENTITY, OR TRUSTWORTHINESS OF ANY USER

---

## 7. Event and Show Listings

### 7.1 Accuracy of Listings

Coin show dates, venues, and details listed on the Platform are compiled from publicly available sources and user submissions. **We do not guarantee the accuracy, completeness, or timeliness of any event listing.** Dates and venues can change without notice. Always verify details with the official show organizer before traveling.

### 7.2 Promoter Submissions

Show Promoters are solely responsible for the accuracy of event information submitted through the Platform. We reserve the right to edit, reject, or remove any listing at our sole discretion.

### 7.3 No Endorsement

Listing a coin show or event on the Platform does not constitute endorsement, sponsorship, or affiliation with the show organizer.
...
You retain ownership of all content you submit to the Platform, including text, photographs, descriptions, and other materials ("User Content").

### 8.2 License Grant

By submitting User Content, you grant us a worldwide, non-exclusive, royalty-free, transferable, sublicensable license to use, reproduce, modify, display, distribute, and create derivative works from your User Content solely for the purpose of operating and promoting the Platform.
...
- Containing malware, spam, or unauthorized advertising
...
- Use the Platform to facilitate the sale of stolen, counterfeit, or illegally obtained items
- Harass, threaten, or abuse any other user
- Scrape or collect user information without consent
...
*This document is provided for informational purposes and does not constitute legal advice. We recommend consulting with a qualified attorney to review and customize these terms for your specific situation.*
